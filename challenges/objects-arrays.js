...
zooAnimals.forEach(function (item) { displayNames.push(`Name: ${item.animal_name}, Scentific: ${item.scientific_name}`) })
...
*/
const populationTotal = zooAnimals.reduce((acc, cur) => ({population: acc.population + cur.population }));
